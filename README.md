...
`External Evidence Verifier` は、提出直前に審査員が開くURLをライブ検証します。任意URLを無制限にfetchせず、公開GitHub、Cloud Run、ProtoPedia、YouTube/Vimeo/Google Driveだけを許可し、ProtoPedia作品URLと動画URLが未入力・不正・非公開なら `needs-external-urls` として残します。
