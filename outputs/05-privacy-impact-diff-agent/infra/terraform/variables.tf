...
variable "service_name" {
  ...
  type        = string
  default     = "privacy-impact-diff-agent"
...
variable "repository_id" {
  ...
  type        = string
  default     = "privacy-impact-diff-agent-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-05-privacy-impact-diff-agen"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "privacy-impact-diff-agent-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "privacy-impact-diff-agent-api-auth-token"
}
