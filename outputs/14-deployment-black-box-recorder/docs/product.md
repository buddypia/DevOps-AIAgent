# Product Strategy: Deployment Black Box Recorder
...
- Urgent pain: deployment evidence recorder decisions require scattered evidence and are still made by whoever happens to be online.

## Job To Be Done

When evidence capture, timeline anchors, incident replay create ambiguity, the user wants to turn raw operational evidence into a decision, owner, verification command, and shareable comment before the window closes.

## Wedge Hypothesis

If Deployment Black Box Recorder can make one high-pressure evidence capture decision faster and easier to explain, teams will first use it as a review/incident assistant, then ask for deeper integrations with GitHub, Cloud Logging, Cloud Monitoring, Slack, and audit storage.
