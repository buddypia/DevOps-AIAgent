...
variable "service_name" {
  ...
  type        = string
  default     = "deployment-black-box-recorder"
...
variable "repository_id" {
  ...
  type        = string
  default     = "deployment-black-box-recorder-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-14-deployment-black-box-rec"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "deployment-black-box-recorder-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "deployment-black-box-recorder-api-auth-token"
}
