...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Deployment Black Box Recorder."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Deployment Black Box Recorder Cloud Run runtime"
  description  = "Runtime identity for the Deployment Black Box Recorder hackathon Cloud Run service."
