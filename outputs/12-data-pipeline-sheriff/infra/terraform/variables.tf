...
variable "repository_id" {
  ...
  type        = string
  default     = "data-pipeline-sheriff-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-12-data-pipeline-sheriff"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "data-pipeline-sheriff-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "data-pipeline-sheriff-api-auth-token"
}
