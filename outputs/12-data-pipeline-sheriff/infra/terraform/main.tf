...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Data Pipeline Sheriff."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Data Pipeline Sheriff Cloud Run runtime"
  description  = "Runtime identity for the Data Pipeline Sheriff hackathon Cloud Run service."
