...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "chaos-drill-agent-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "chaos-drill-agent-api-auth-token"
}
