...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Chaos Drill Agent."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Chaos Drill Agent Cloud Run runtime"
  description  = "Runtime identity for the Chaos Drill Agent hackathon Cloud Run service."
