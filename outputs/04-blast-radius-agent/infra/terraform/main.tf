...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Blast Radius Agent."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Blast Radius Agent Cloud Run runtime"
  description  = "Runtime identity for the Blast Radius Agent hackathon Cloud Run service."
