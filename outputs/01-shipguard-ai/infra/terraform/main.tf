...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for ShipGuard AI."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "ShipGuard AI Cloud Run runtime"
  description  = "Runtime identity for the ShipGuard AI hackathon Cloud Run service."
