...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "post-deploy-judge-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "post-deploy-judge-api-auth-token"
}
