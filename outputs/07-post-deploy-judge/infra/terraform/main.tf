...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Post Deploy Judge."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Post Deploy Judge Cloud Run runtime"
  description  = "Runtime identity for the Post Deploy Judge hackathon Cloud Run service."
