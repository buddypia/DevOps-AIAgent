...
variable "service_name" {
  ...
  type        = string
  default     = "recovery-confidence-meter"
...
variable "repository_id" {
  ...
  type        = string
  default     = "recovery-confidence-meter-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-08-recovery-confidence-mete"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "recovery-confidence-meter-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "recovery-confidence-meter-api-auth-token"
}
