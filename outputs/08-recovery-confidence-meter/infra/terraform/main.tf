...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Recovery Confidence Meter."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Recovery Confidence Meter Cloud Run runtime"
  description  = "Runtime identity for the Recovery Confidence Meter hackathon Cloud Run service."
