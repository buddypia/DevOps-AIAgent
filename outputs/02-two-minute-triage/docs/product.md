# Product Strategy: Two Minute Triage
...
- Urgent pain: incident first-response agent decisions require scattered evidence and are still made by whoever happens to be online.

## Job To Be Done

When first signal selection, owner routing, noise reduction create ambiguity, the user wants to turn raw operational evidence into a decision, owner, verification command, and shareable comment before the window closes.

## Wedge Hypothesis

If Two Minute Triage can make one high-pressure first signal selection decision faster and easier to explain, teams will first use it as a review/incident assistant, then ask for deeper integrations with GitHub, Cloud Logging, Cloud Monitoring, Slack, and audit storage.
