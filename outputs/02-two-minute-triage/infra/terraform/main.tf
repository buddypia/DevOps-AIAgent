...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Two Minute Triage."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Two Minute Triage Cloud Run runtime"
  description  = "Runtime identity for the Two Minute Triage hackathon Cloud Run service."
