...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "two-minute-triage-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "two-minute-triage-api-auth-token"
}
