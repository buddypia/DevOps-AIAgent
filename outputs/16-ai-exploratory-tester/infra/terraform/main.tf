...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for AI Exploratory Tester."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "AI Exploratory Tester Cloud Run runtime"
  description  = "Runtime identity for the AI Exploratory Tester hackathon Cloud Run service."
