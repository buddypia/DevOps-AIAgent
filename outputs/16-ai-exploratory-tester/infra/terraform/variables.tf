...
variable "repository_id" {
  ...
  type        = string
  default     = "ai-exploratory-tester-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-16-ai-exploratory-tester"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "ai-exploratory-tester-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "ai-exploratory-tester-api-auth-token"
}
