...
variable "service_name" {
  ...
  type        = string
  default     = "deploy-rehearsal-agent"
...
variable "repository_id" {
  ...
  type        = string
  default     = "deploy-rehearsal-agent-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-06-deploy-rehearsal-agent"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "deploy-rehearsal-agent-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "deploy-rehearsal-agent-api-auth-token"
}
