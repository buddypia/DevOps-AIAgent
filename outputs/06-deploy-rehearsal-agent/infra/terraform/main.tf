...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Deploy Rehearsal Agent."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Deploy Rehearsal Agent Cloud Run runtime"
  description  = "Runtime identity for the Deploy Rehearsal Agent hackathon Cloud Run service."
