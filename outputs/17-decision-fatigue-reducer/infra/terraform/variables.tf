...
variable "service_name" {
  ...
  type        = string
  default     = "decision-fatigue-reducer"
...
variable "repository_id" {
  ...
  type        = string
  default     = "decision-fatigue-reducer-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-17-decision-fatigue-reducer"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "decision-fatigue-reducer-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "decision-fatigue-reducer-api-auth-token"
}
