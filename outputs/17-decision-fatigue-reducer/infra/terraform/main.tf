...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Decision Fatigue Reducer."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Decision Fatigue Reducer Cloud Run runtime"
  description  = "Runtime identity for the Decision Fatigue Reducer hackathon Cloud Run service."
