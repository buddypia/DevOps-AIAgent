...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Rollback Concierge."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Rollback Concierge Cloud Run runtime"
  description  = "Runtime identity for the Rollback Concierge hackathon Cloud Run service."
