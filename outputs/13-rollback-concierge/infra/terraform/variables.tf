...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "rollback-concierge-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "rollback-concierge-api-auth-token"
}
