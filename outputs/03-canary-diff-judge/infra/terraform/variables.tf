...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "canary-diff-judge-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "canary-diff-judge-api-auth-token"
}
