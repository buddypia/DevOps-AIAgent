...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Canary Diff Judge."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Canary Diff Judge Cloud Run runtime"
  description  = "Runtime identity for the Canary Diff Judge hackathon Cloud Run service."
