...
variable "service_name" {
  ...
  type        = string
  default     = "runbook-decay-detector"
...
variable "repository_id" {
  ...
  type        = string
  default     = "runbook-decay-detector-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-11-runbook-decay-detector"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "runbook-decay-detector-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "runbook-decay-detector-api-auth-token"
}
