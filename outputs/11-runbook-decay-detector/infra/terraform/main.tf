...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Runbook Decay Detector."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Runbook Decay Detector Cloud Run runtime"
  description  = "Runtime identity for the Runbook Decay Detector hackathon Cloud Run service."
