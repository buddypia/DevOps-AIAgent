...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Cloud Run Traffic Mixer."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Cloud Run Traffic Mixer Cloud Run runtime"
  description  = "Runtime identity for the Cloud Run Traffic Mixer hackathon Cloud Run service."
