...
variable "service_name" {
  ...
  type        = string
  default     = "cloud-run-traffic-mixer"
...
variable "repository_id" {
  ...
  type        = string
  default     = "cloud-run-traffic-mixer-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-10-cloud-run-traffic-mixer"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "cloud-run-traffic-mixer-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "cloud-run-traffic-mixer-api-auth-token"
}
