...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Incident Commander Karaoke."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Incident Commander Karaoke Cloud Run runtime"
  description  = "Runtime identity for the Incident Commander Karaoke hackathon Cloud Run service."
