...
variable "service_name" {
  ...
  type        = string
  default     = "incident-commander-karaoke"
...
variable "repository_id" {
  ...
  type        = string
  default     = "incident-commander-karaoke-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-20-incident-commander-karao"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "incident-commander-karaoke-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "incident-commander-karaoke-api-auth-token"
}
