...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Eval Dataset Gardener."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Eval Dataset Gardener Cloud Run runtime"
  description  = "Runtime identity for the Eval Dataset Gardener hackathon Cloud Run service."
