...
variable "repository_id" {
  ...
  type        = string
  default     = "eval-dataset-gardener-repo"
}

variable "runtime_service_account_id" {
  description = "Service account ID used by the Cloud Run revision."
  type        = string
  default     = "sa-09-eval-dataset-gardener"
}
...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "eval-dataset-gardener-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "eval-dataset-gardener-api-auth-token"
}
