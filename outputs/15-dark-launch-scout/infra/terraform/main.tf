...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Dark Launch Scout."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Dark Launch Scout Cloud Run runtime"
  description  = "Runtime identity for the Dark Launch Scout hackathon Cloud Run service."
