...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "dark-launch-scout-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "dark-launch-scout-api-auth-token"
}
