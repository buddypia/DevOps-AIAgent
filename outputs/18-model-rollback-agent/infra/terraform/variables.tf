...
variable "gemini_api_secret_id" {
  ...
  type        = string
  default     = "model-rollback-agent-gemini-api-key"
}
...
variable "api_auth_secret_id" {
  ...
  type        = string
  default     = "model-rollback-agent-api-auth-token"
}
