...
resource "google_artifact_registry_repository" "app" {
  ...
  description   = "Docker images for Model Rollback Agent."
  format        = "DOCKER"
  labels        = local.labels
...
resource "google_service_account" "runtime" {
  ...
  display_name = "Model Rollback Agent Cloud Run runtime"
  description  = "Runtime identity for the Model Rollback Agent hackathon Cloud Run service."
