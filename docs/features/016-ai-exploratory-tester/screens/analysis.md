# スクリーン: AI Exploratory Tester Analysis Console

> **画面ID**: SCR-016-analysis | **関連SPEC**: [SPEC-016-ai-exploratory-tester](../SPEC-016-ai-exploratory-tester.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/16-ai-exploratory-tester/src/main.ts |
| ルート | / |
...
| 成功 | TEST NOW / EXPLORE MORE / BLOCK RELEASE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-016-ai-exploratory-tester.md](../SPEC-016-ai-exploratory-tester.md) §0.2、§0.5、§2
