# スクリーン: Data Pipeline Sheriff Analysis Console

> **画面ID**: SCR-012-analysis | **関連SPEC**: [SPEC-012-data-pipeline-sheriff](../SPEC-012-data-pipeline-sheriff.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/12-data-pipeline-sheriff/src/main.ts |
| ルート | / |
...
| 成功 | RERUN / HOLD DATA / ESCALATE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-012-data-pipeline-sheriff.md](../SPEC-012-data-pipeline-sheriff.md) §0.2、§0.5、§2
