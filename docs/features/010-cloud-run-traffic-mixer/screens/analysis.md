# スクリーン: Cloud Run Traffic Mixer Analysis Console

> **画面ID**: SCR-010-analysis | **関連SPEC**: [SPEC-010-cloud-run-traffic-mixer](../SPEC-010-cloud-run-traffic-mixer.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/10-cloud-run-traffic-mixer/src/main.ts |
| ルート | / |
...
| 成功 | SHIFT UP / HOLD SPLIT / SHIFT DOWN、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-010-cloud-run-traffic-mixer.md](../SPEC-010-cloud-run-traffic-mixer.md) §0.2、§0.5、§2
