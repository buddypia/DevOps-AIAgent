# スクリーン: Two Minute Triage Analysis Console

> **画面ID**: SCR-002-analysis | **関連SPEC**: [SPEC-002-two-minute-triage](../SPEC-002-two-minute-triage.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/02-two-minute-triage/src/main.ts |
| ルート | / |
...
| 成功 | STABILIZE / INVESTIGATE / ESCALATE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-002-two-minute-triage.md](../SPEC-002-two-minute-triage.md) §0.2、§0.5、§2
