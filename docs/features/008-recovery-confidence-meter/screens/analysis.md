# スクリーン: Recovery Confidence Meter Analysis Console

> **画面ID**: SCR-008-analysis | **関連SPEC**: [SPEC-008-recovery-confidence-meter](../SPEC-008-recovery-confidence-meter.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/08-recovery-confidence-meter/src/main.ts |
| ルート | / |
...
| 成功 | CLOSE / VERIFY / KEEP INCIDENT OPEN、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-008-recovery-confidence-meter.md](../SPEC-008-recovery-confidence-meter.md) §0.2、§0.5、§2
