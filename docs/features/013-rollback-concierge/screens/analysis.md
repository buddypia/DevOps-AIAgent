# スクリーン: Rollback Concierge Analysis Console

> **画面ID**: SCR-013-analysis | **関連SPEC**: [SPEC-013-rollback-concierge](../SPEC-013-rollback-concierge.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/13-rollback-concierge/src/main.ts |
| ルート | / |
...
| 成功 | ROLLBACK READY / MANUAL CHECK / DO NOT ROLLBACK、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-013-rollback-concierge.md](../SPEC-013-rollback-concierge.md) §0.2、§0.5、§2
