# スクリーン: Deployment Black Box Recorder Analysis Console

> **画面ID**: SCR-014-analysis | **関連SPEC**: [SPEC-014-deployment-black-box-recorder](../SPEC-014-deployment-black-box-recorder.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/14-deployment-black-box-recorder/src/main.ts |
| ルート | / |
...
| 成功 | RECORD / ENRICH RECORD / MISSING EVIDENCE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-014-deployment-black-box-recorder.md](../SPEC-014-deployment-black-box-recorder.md) §0.2、§0.5、§2
