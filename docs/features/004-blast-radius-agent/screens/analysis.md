# スクリーン: Blast Radius Agent Analysis Console

> **画面ID**: SCR-004-analysis | **関連SPEC**: [SPEC-004-blast-radius-agent](../SPEC-004-blast-radius-agent.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/04-blast-radius-agent/src/main.ts |
| ルート | / |
...
| 成功 | LOW RADIUS / WATCH RADIUS / HIGH RADIUS、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-004-blast-radius-agent.md](../SPEC-004-blast-radius-agent.md) §0.2、§0.5、§2
