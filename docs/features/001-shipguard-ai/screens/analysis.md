# スクリーン: ShipGuard AI Analysis Console

> **画面ID**: SCR-001-analysis | **関連SPEC**: [SPEC-001-shipguard-ai](../SPEC-001-shipguard-ai.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/01-shipguard-ai/src/main.ts |
| ルート | / |
...
| 成功 | SHIP / WATCH / BLOCK、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-001-shipguard-ai.md](../SPEC-001-shipguard-ai.md) §0.2、§0.5、§2
