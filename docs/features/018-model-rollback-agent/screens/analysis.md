# スクリーン: Model Rollback Agent Analysis Console

> **画面ID**: SCR-018-analysis | **関連SPEC**: [SPEC-018-model-rollback-agent](../SPEC-018-model-rollback-agent.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/18-model-rollback-agent/src/main.ts |
| ルート | / |
...
| 成功 | KEEP MODEL / CANARY / ROLLBACK MODEL、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-018-model-rollback-agent.md](../SPEC-018-model-rollback-agent.md) §0.2、§0.5、§2
