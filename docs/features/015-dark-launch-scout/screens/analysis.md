# スクリーン: Dark Launch Scout Analysis Console

> **画面ID**: SCR-015-analysis | **関連SPEC**: [SPEC-015-dark-launch-scout](../SPEC-015-dark-launch-scout.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/15-dark-launch-scout/src/main.ts |
| ルート | / |
...
| 成功 | LAUNCH / KEEP DARK / DISABLE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-015-dark-launch-scout.md](../SPEC-015-dark-launch-scout.md) §0.2、§0.5、§2
