# スクリーン: Runbook Decay Detector Analysis Console

> **画面ID**: SCR-011-analysis | **関連SPEC**: [SPEC-011-runbook-decay-detector](../SPEC-011-runbook-decay-detector.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/11-runbook-decay-detector/src/main.ts |
| ルート | / |
...
| 成功 | FRESH / PATCH DOCS / STALE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-011-runbook-decay-detector.md](../SPEC-011-runbook-decay-detector.md) §0.2、§0.5、§2
