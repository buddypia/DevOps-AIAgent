# スクリーン: Decision Fatigue Reducer Analysis Console

> **画面ID**: SCR-017-analysis | **関連SPEC**: [SPEC-017-decision-fatigue-reducer](../SPEC-017-decision-fatigue-reducer.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/17-decision-fatigue-reducer/src/main.ts |
| ルート | / |
...
| 成功 | DECIDE THREE / DEFER / ESCALATE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-017-decision-fatigue-reducer.md](../SPEC-017-decision-fatigue-reducer.md) §0.2、§0.5、§2
