# スクリーン: Chaos Drill Agent Analysis Console

> **画面ID**: SCR-019-analysis | **関連SPEC**: [SPEC-019-chaos-drill-agent](../SPEC-019-chaos-drill-agent.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/19-chaos-drill-agent/src/main.ts |
| ルート | / |
...
| 成功 | RUN DRILL / TIGHTEN GUARDRAILS / DO NOT RUN、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-019-chaos-drill-agent.md](../SPEC-019-chaos-drill-agent.md) §0.2、§0.5、§2
