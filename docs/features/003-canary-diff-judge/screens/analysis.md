# スクリーン: Canary Diff Judge Analysis Console

> **画面ID**: SCR-003-analysis | **関連SPEC**: [SPEC-003-canary-diff-judge](../SPEC-003-canary-diff-judge.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/03-canary-diff-judge/src/main.ts |
| ルート | / |
...
| 成功 | PROMOTE / HOLD / ROLLBACK、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-003-canary-diff-judge.md](../SPEC-003-canary-diff-judge.md) §0.2、§0.5、§2
