# スクリーン: Post Deploy Judge Analysis Console

> **画面ID**: SCR-007-analysis | **関連SPEC**: [SPEC-007-post-deploy-judge](../SPEC-007-post-deploy-judge.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/07-post-deploy-judge/src/main.ts |
| ルート | / |
...
| 成功 | SUCCESS / WATCH / ROLLBACK、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-007-post-deploy-judge.md](../SPEC-007-post-deploy-judge.md) §0.2、§0.5、§2
