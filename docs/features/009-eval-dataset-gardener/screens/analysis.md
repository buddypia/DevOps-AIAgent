# スクリーン: Eval Dataset Gardener Analysis Console

> **画面ID**: SCR-009-analysis | **関連SPEC**: [SPEC-009-eval-dataset-gardener](../SPEC-009-eval-dataset-gardener.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/09-eval-dataset-gardener/src/main.ts |
| ルート | / |
...
| 成功 | ADD CASES / CURATE / BLOCK MODEL CHANGE、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-009-eval-dataset-gardener.md](../SPEC-009-eval-dataset-gardener.md) §0.2、§0.5、§2
