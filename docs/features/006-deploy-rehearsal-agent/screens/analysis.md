# スクリーン: Deploy Rehearsal Agent Analysis Console

> **画面ID**: SCR-006-analysis | **関連SPEC**: [SPEC-006-deploy-rehearsal-agent](../SPEC-006-deploy-rehearsal-agent.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/06-deploy-rehearsal-agent/src/main.ts |
| ルート | / |
...
| 成功 | READY / REHEARSE / NOT READY、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-006-deploy-rehearsal-agent.md](../SPEC-006-deploy-rehearsal-agent.md) §0.2、§0.5、§2
