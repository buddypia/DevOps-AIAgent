# スクリーン: Incident Commander Karaoke Analysis Console

> **画面ID**: SCR-020-analysis | **関連SPEC**: [SPEC-020-incident-commander-karaoke](../SPEC-020-incident-commander-karaoke.md)

## 1. 画面情報

| 項目 | 内容 |
|---|---|
| 実装 | outputs/20-incident-commander-karaoke/src/main.ts |
| ルート | / |
...
| 成功 | GOOD COMMAND / COACH / RETRY COMMAND、confidence、summary、evidence、actions | 根拠を確認/再実行 |
...
- [SPEC-020-incident-commander-karaoke.md](../SPEC-020-incident-commander-karaoke.md) §0.2、§0.5、§2
